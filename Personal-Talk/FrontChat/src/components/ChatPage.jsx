...
function ChatPage() {
    ...
    // stompClient ko init karna koga
    ...
    // send message ko handle kar na hoga
    ...
    return (
        <div>
            ...
            <main ref={chatBoxRef} className="py-20 px-10   w-2/3 dark:bg-slate-600 mx-auto h-screen overflow-auto ">
                ...
                {
                    // Here in the arrow function () is used on both side before the arrow and after the arrow 
